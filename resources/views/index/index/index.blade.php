...
<link rel="shortcut icon" href="favicon.ico">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('/static/index/css/base.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('/static/index/css/style.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('/static/index/css/iconfont.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('/static/index/css/purebox.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('/static/index/css/quickLinks.css')}}">
<script type="text/javascript" src="{{URL::asset('/static/index/js/jquery-1.9.1.min.js')}}"></script>
<script type="text/javascript" src="{{URL::asset('/static/index/js/jquery.json.js')}}"></script>
<script type="text/javascript" src="{{URL::asset('/static/index/js/transport_jquery.js')}}"></script>
...
//加载效果
var load_cart_info = '<img src="./img/loadGoods.gif" height="108" class="ml100">';
var load_icon = '<img src="./img/load.gif" width="200" height="200">';
</script></head>
...
<div class="header">
    <div class="w w1200">
        <div class="logo">
            <div class="logoImg"><a href="#"><img src="{{URL::asset('/static/index/img/logo.png')}}"></a></div>
            <div class="logoAdv"><!-- <a href="#"><img src="./img/ecsc-join.gif"></a> --></div>
        </div>
...
<ul class="cate-logo">
	<li><a href="#"><img src="./img/1490071974970349584.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490072756032175204.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490073577683159021.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490073591535005714.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490072860522023692.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490074030328949587.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490228075580091113.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490074901892372216.jpg" width="112" height="49"></a></li>
</ul>
	</div>
</div>
					</div>
...
<div class="categorys-items-layer" ectype="cateLayer" style="display: none;">
	...
	<li><a href="#">卫裤/运动裤</a></li>
		...
		<ul class="cate-logo">
	<li><a href="#"><img src="./img/1490073529881448780.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490072981305868823.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490072373278367315.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490072879222701895.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490073539440462760.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490072765604121481.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490073675778205608.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490073240845049320.jpg" width="112" height="49"></a></li>
</ul>
	</div>
</div>
					</div>
...
<div class="categorys-items-layer" ectype="cateLayer" style="display: none;">
	...
	<li><a href="#">女士腰带/礼盒</a></li>
		...
		<ul class="cate-logo">    <li><a href="#"><img src="./img/1490228100138579787.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490072804442637685.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490171981556005380.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490073561018734078.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490072823106532144.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490072677495061584.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490074901892372216.jpg" width="112" height="49"></a></li>
</ul>
	</div>
</div>
...
<div class="categorys-items-layer" ectype="cateLayer" style="display: none;">
	...
	<li><a href="#">大码内衣</a></li>
		...
		<ul class="cate-logo">    <li><a href="#"><img src="./img/1490072950580851309.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490227784119952387.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490073518703639070.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490073982547710498.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490074308773778697.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490072313895957648.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490073454678614186.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490227986732712711.jpg" width="112" height="49"></a></li>
</ul>
	</div>
</div>
					</div>
...
<div class="categorys-items-layer" ectype="cateLayer" style="display: none;">
	...
	<li><a href="#">水上运动</a></li>
		...
		<ul class="cate-logo">    <li><a href="#"><img src="./img/1490072850306019115.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490072931218635674.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490072898345358625.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490073009638652059.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490073324022460149.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490072918339853569.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490072889090025069.jpg" width="112" height="49"></a></li>
    <li><a href="#"><img src="./img/1490072993409028193.jpg" width="112" height="49"></a></li>
</ul>
	</div>
</div>
					</div>
  ...
  <li style="position: absolute; width: 1903px; left: 0px; top: 0px; display: none;"><div class="banner-width"><a style="background: url(./img/1489958299308242697.jpg) no-repeat;" href="https://www.dscmall.cn/" width="1903" height="327"></a></div></li>
  <li style="position: absolute; width: 1903px; left: 0px; top: 0px; display: none;"><div class="banner-width"><a style="background: url(./img/1490123276201426626.jpg) no-repeat;" href="https://www.dscmall.cn/" width="1903" height="327"></a></div></li>
  <li style="position: absolute; width: 1903px; left: 0px; top: 0px; display: none;"><div class="banner-width"><a style="background: url(./img/1490123436237080312.jpg) no-repeat;" href="https://www.dscmall.cn/" width="1903" height="327"></a></div></li>
  <li style="position: absolute; width: 1903px; left: 0px; top: 0px; display: none;"><div class="banner-width"><a style="background: url(./img/1490123306523369831.jpg) no-repeat;" href="https://www.dscmall.cn/" width="1903" height="327"></a></div></li>
  <li style="position: absolute; width: 1903px; left: 0px; top: 0px; display: list-item;"><div class="banner-width"><a style="background: url(./img/1490123319351624402.jpg) no-repeat;" href="https://www.dscmall.cn/" width="1903" height="327"></a></div></li>
</ul>
</div>
		...
		<div class="bd">
			<ul class="limitime-list clearfix">
				...
				<li class="mod-shadow-card">
					<a href="#" class="img"><img src="./img/0_thumb_G_1490174547624.jpg" alt=""></a>
					<p class="price">
													 <em>¥</em>124.00
				...
				<li class="mod-shadow-card">
					<a href="#" class="img"><img src="./img/0_thumb_G_1490174303715.jpg" alt=""></a>
					<p class="price">
													 <em>¥</em>130.00
				...
				<li class="mod-shadow-card">
					<a href="#" class="img"><img src="./img/0_thumb_G_1490174741051.jpg" alt=""></a>
					<p class="price">
													 <em>¥</em>40.00
						<del><em>¥</em>78.00</del>
					</p>
...
<div class="catetop-floor" id="floor_1" ectype="floorItem">
	...
	<div class="f-bd clearfix">
		<div class="bd-left">
			<div class="l-ad"><ul>    <li><a href="#"><img src="./img/1489959091429324080.jpg" width="400" height="660"></a></li>
</ul></div>
		</div>
		<div class="bd-right">
			<div class="right-top clearfix">
				<div class="rt-ad"><a href="#"><img src="./img/1490902198662849705.png" width="399" height="170"></a></div>
<div class="rt-ad"><a href="#"><img src="./img/1490902716880024601.jpg" width="399" height="170"></a></div>
			</div>
...
<div class="p-price"><em>¥</em>112.00</div>
				...
				<li>
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1490174858999.jpg" alt=""></a></div>
...
<div class="p-price"><em>¥</em>68.00</div>
				...
				<ul class="fgoods-list" style="position: absolute; width: 804px; left: 0px; top: 0px; display: none;">
				<li>
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1490174741051.jpg" alt=""></a></div>
<div class="p-name"><a href="#">初棉纯色圆领长袖T恤打底衫秋衣女上衣体恤女士修身打底衣春秋 挺拔有型 棉氨材质 柔软舒适 耐洗耐磨</a></div>
<div class="p-price"><em>¥</em>65.00</div>
					</li>
				<li>
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1489102753231.jpg" alt=""></a></div>
...
<div class="p-price"><em>¥</em>300.00</div>
				...
				<ul class="fgoods-list" style="position: absolute; width: 804px; left: 0px; top: 0px; display: none;">
				<li>
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1490174791219.jpg" alt=""></a></div>
<div class="p-name"><a href="#">17年春夏新款百搭半身裙蛋糕裙 a字裙 裤裙伞裙大码裙子超短裙女 松紧腰围 带裤边打底衬 涤针织面料</a></div>
<div class="p-price"><em>¥</em>49.00</div>
					</li>
				<li>
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1489102299856.jpg" alt=""></a></div>
...
<div class="p-price"><em>¥</em>233.00</div>
		...
		<div class="clear"></div>
				<ul class="brands">
			<li><a href="#"><img src="./img/1490071974970349584.jpg" alt="esprit"></a></li>
<li><a href="#"><img src="./img/1490072756032175204.jpg" alt="喜瑞"></a></li>
<li><a href="#"><img src="./img/1490073577683159021.jpg" alt="华帝"></a></li>
<li><a href="#"><img src="./img/1490073591535005714.jpg" alt="鸿星尔克"></a></li>
<li><a href="#"><img src="./img/1490072860522023692.jpg" alt="乐力"></a></li>
<li><a href="#"><img src="./img/1490074030328949587.jpg" alt="LG"></a></li>
<li><a href="#"><img src="./img/1490228075580091113.jpg" alt="麦斯威尔"></a></li>
<li><a href="#"><img src="./img/1490074901892372216.jpg" alt="美的"></a></li>
		</ul>
			</div>
</div>
...
<div class="catetop-floor" id="floor_2" ectype="floorItem">
	...
	<div class="f-bd clearfix">
		<div class="bd-left">
			<div class="l-ad"><ul>    <li><a href="#"><img src="./img/1490211733278354775.png" width="400" height="660"></a></li>
</ul></div>
		</div>
		<div class="bd-right">
			<div class="right-top clearfix">
				<div class="rt-ad"><a href="#"><img src="./img/1490902568354711628.jpg" width="399" height="170"></a></div>
<div class="rt-ad"><a href="#"><img src="./img/1490902583818745610.jpg" width="399" height="170"></a></div>
			</div>
			<div class="right-bottom" style="position: relative; width: 800px; height: 488px;">
<ul class="fgoods-list" style="position: absolute; width: 804px; left: 0px; top: 0px;">
				<li>
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1490211620029.jpg" alt=""></a></div>
<div class="p-name"><a href="#">马克华菲长袖T恤男士圆领修身韩版刺绣纯棉2017春装新款潮t 7002 立体3D绣花 欧美潮流范 17春装新品</a></div>
<div class="p-price"><em>¥</em>128.00</div>
					</li>
				<li>
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1490211575591.jpg" alt=""></a></div>
<div class="p-name"><a href="#">马克华菲长袖T恤男 冬季新品纯棉圆领黑白潮款印花休闲t恤   98</a></div>
<div class="p-price"><em>¥</em>98.00</div>
					</li>
				<li>
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1490211700709.jpg" alt=""></a></div>
<div class="p-name"><a href="#">美特斯邦威长袖T恤男士2017春装新款时尚印花百搭205064商场同款 1元秒100元优惠券丨限量抢丨立即抢购</a></div>
<div class="p-price"><em>¥</em>89.00</div>
					</li>
				<li>
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1489099773629.jpg" alt=""></a></div>
<div class="p-name"><a href="#">2017春装新款男士卫衣套头圆领韩版潮流时尚男生休闲外套</a></div>
<div class="p-price"><em>¥</em>200.00</div>
					</li>
				<li>
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1489099544749.jpg" alt=""></a></div>
<div class="p-name"><a href="#">秋冬新款加绒圆领套头卫衣男青年男生韩版潮流学生休闲外套男</a></div>
<div class="p-price"><em>¥</em>168.00</div>
					</li>
				<li>
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1489099437211.jpg" alt=""></a></div>
<div class="p-name"><a href="#">秋季新款男士套头卫衣印花外套韩版简约百搭潮流男生上衣服</a></div>
<div class="p-price"><em>¥</em>120.00</div>
					</li>
				<li>
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1490174019725.jpg" alt=""></a></div>
<div class="p-name"><a href="#">HLA/海澜之家撞色长袖T恤春季热卖圆领修身拼接T恤男 简约圆领 微弹修身 撞色拼接 触感柔软</a></div>
<div class="p-price"><em>¥</em>98.00</div>
					</li>
				<li>
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1490211843119.jpg" alt=""></a></div>
<div class="p-name"><a href="#">马克华菲短袖T恤 夏装新款舒适圆领条纹拼接男简约修身短袖上衣</a></div>
<div class="p-price"><em>¥</em>128.00</div>
					</li>
				<li>
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1490174208112.jpg" alt=""></a></div>
<div class="p-name"><a href="#">森马夹克 2016冬装新款男士飞行夹克贴布绣立领休闲外套韩版潮流</a></div>
<div class="p-price"><em>¥</em>199.90</div>
					</li>
				<li>
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1490174303715.jpg" alt=""></a></div>
...
<div class="p-price"><em>¥</em>159.00</div>
				...
				<ul class="fgoods-list" style="position: absolute; width: 804px; left: 0px; top: 0px; display: none;">
				<li>
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1490174241651.jpg" alt=""></a></div>
...
<div class="p-price"><em>¥</em>99.00</div>
		...
		<div class="clear"></div>
				<ul class="brands">
			<li><a href="#"><img src="./img/1490073529881448780.jpg" alt="匡威"></a></li>
<li><a href="#"><img src="./img/1490072981305868823.jpg" alt="开普特"></a></li>
<li><a href="#"><img src="./img/1490072373278367315.jpg" alt="金利来"></a></li>
<li><a href="#"><img src="./img/1490072879222701895.jpg" alt="金史密斯"></a></li>
<li><a href="#"><img src="./img/1490073539440462760.jpg" alt="康恩贝"></a></li>
<li><a href="#"><img src="./img/1490072765604121481.jpg" alt="康比特"></a></li>
<li><a href="#"><img src="./img/1490073675778205608.jpg" alt="哥弟"></a></li>
<li><a href="#"><img src="./img/1490073240845049320.jpg" alt="小米"></a></li>
		</ul>
			</div>
</div>
...
<div class="catetop-floor" id="floor_3" ectype="floorItem">
	...
	<div class="f-bd clearfix">
		<div class="bd-left">
			<div class="l-ad"><ul>    <li><a href="#"><img src="./img/1490211940085510775.png" width="400" height="660"></a></li>
</ul></div>
		</div>
		<div class="bd-right">
			<div class="right-top clearfix">
				<div class="rt-ad"><a href="#"><img src="./img/1490902595862278495.jpg" width="399" height="170"></a></div>
<div class="rt-ad"><a href="#"><img src="./img/1490902606945055998.jpg" width="399" height="170"></a></div>
			</div>
			<div class="right-bottom" style="position: relative; width: 800px; height: 488px;">
<ul class="fgoods-list" style="position: absolute; width: 804px; left: 0px; top: 0px;">
				<li>
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1490173894447.jpg" alt=""></a></div>
<div class="p-name"><a href="#">红叶伞遮阳伞防紫外线黑胶防晒晴雨两用太阳伞女糖果色折叠雨伞大 黑胶防晒 晴雨两用 糖果色 都市风情</a></div>
<div class="p-price"><em>¥</em>38.00</div>
					</li>
				<li>
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1490173663577.jpg" alt=""></a></div>
<div class="p-name"><a href="#">男女韩版纯棉可爱冬季个性防尘情侣口罩保暖透气黑色时尚潮款春 15元一共2个口罩 防尘个性时尚</a></div>
<div class="p-price"><em>¥</em>15.00</div>
					</li>
				<li>
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1490155369648.jpg" alt=""></a></div>
<div class="p-name"><a href="#">Apple/苹果 Apple Watch Series 2 智能手表42mm</a></div>
<div class="p-price"><em>¥</em>3188.00</div>
					</li>
				<li>
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1489108087695.jpg" alt=""></a></div>
...
<div class="p-price"><em>¥</em>219.00</div>
		...
		<div class="clear"></div>
				<ul class="brands">
			<li><a href="#"><img src="./img/1490228100138579787.jpg" alt="杰克琼斯"></a></li>
<li><a href="#"><img src="./img/1490072804442637685.jpg" alt="健安喜"></a></li>
<li><a href="#"><img src="./img/1490171981556005380.jpg" alt="佳沪数码-华为"></a></li>
<li><a href="#"><img src="./img/1490073561018734078.jpg" alt="姬芮"></a></li>
<li><a href="#"><img src="./img/1490072823106532144.jpg" alt="金奥力"></a></li>
<li><a href="#"><img src="./img/1490072677495061584.jpg" alt="justyle"></a></li>
<li><a href="#"><img src="./img/1490074901892372216.jpg" alt="美的"></a></li>
		</ul>
			</div>
</div>
...
<div class="catetop-floor" id="floor_4" ectype="floorItem">
	...
	<div class="f-bd clearfix">
		<div class="bd-left">
			<div class="l-ad"><ul>    <li><a href="#"><img src="./img/1490211951765051111.png" width="400" height="660"></a></li>
</ul></div>
		</div>
		<div class="bd-right">
			<div class="right-top clearfix">
				<div class="rt-ad"><a href="#"><img src="./img/1490902618861680555.jpg" width="399" height="170"></a></div>
<div class="rt-ad"><a href="#"><img src="./img/1490902628538237349.jpg" width="399" height="170"></a></div>
			</div>
			<div class="right-bottom" style="position: relative; width: 800px; height: 488px;">
<ul class="fgoods-list" style="position: absolute; width: 804px; left: 0px; top: 0px;">
				<li>
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1489099987431.jpg" alt=""></a></div>
<div class="p-name"><a href="#">爆款 爱慕经典KiKi裤轻薄无痕女士中腰三角内裤多色内衣A</a></div>
<div class="p-price"><em>¥</em>88.00</div>
					</li>
				<li>
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1490174547624.jpg" alt=""></a></div>
<div class="p-name"><a href="#">贝妍夏季薄款女士睡衣性感V领女南韩丝家居服运动可外穿中袖套装</a></div>
<div class="p-price"><em>¥</em>138.00</div>
					</li>
				<li>
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1490174469373.jpg" alt=""></a></div>
...
<div class="p-price"><em>¥</em>91.00</div>
		...
		<div class="clear"></div>
				<ul class="brands">
			<li><a href="#"><img src="./img/1490072950580851309.jpg" alt="Masentek"></a></li>
<li><a href="#"><img src="./img/1490227784119952387.jpg" alt="李医生"></a></li>
<li><a href="#"><img src="./img/1490073518703639070.jpg" alt="兰蔻"></a></li>
<li><a href="#"><img src="./img/1490073982547710498.jpg" alt="Five Plus"></a></li>
<li><a href="#"><img src="./img/1490074308773778697.jpg" alt="新百伦"></a></li>
<li><a href="#"><img src="./img/1490072313895957648.jpg" alt="ELLE HOME"></a></li>
<li><a href="#"><img src="./img/1490073454678614186.jpg" alt="狼爪"></a></li>
<li><a href="#"><img src="./img/1490227986732712711.jpg" alt="立邦"></a></li>
		</ul>
			</div>
</div>
...
<div class="catetop-floor" id="floor_5" ectype="floorItem">
	...
	<div class="f-bd clearfix">
		<div class="bd-left">
			<div class="l-ad"><ul>    <li><a href="#"><img src="./img/1490211964186681053.png" width="400" height="660"></a></li>
</ul></div>
		</div>
		<div class="bd-right">
			<div class="right-top clearfix">
				<div class="rt-ad"><a href="#"><img src="./img/1490902637953027856.jpg" width="399" height="170"></a></div>
<div class="rt-ad"><a href="#"><img src="./img/1490902646240694917.jpg" width="399" height="170"></a></div>
			</div>
			<div class="right-bottom" style="position: relative; width: 800px; height: 488px;">
<ul class="fgoods-list" style="position: absolute; width: 804px; left: 0px; top: 0px;">
				<li>
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1490218873837.jpg" alt=""></a></div>
<div class="p-name"><a href="#">Nike 耐克官方 PRO COOL COMP LONG-SLEEVE 男子训练紧身衣703088</a></div>
<div class="p-price"><em>¥</em>249.00</div>
					</li>
				<li>
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1490218667022.jpg" alt=""></a></div>
<div class="p-name"><a href="#">马克华菲长袖T恤男 冬季新品纯棉圆领黑白潮款印花休闲t恤</a></div>
<div class="p-price"><em>¥</em>98.00</div>
					</li>
				<li>
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1490218800612.jpg" alt=""></a></div>
<div class="p-name"><a href="#">洽福 转椅轮子万向轮 老板椅办公椅子滑轮电脑椅配件滚轮脚轮轱辘 静音灵活不伤地板质保三年下单备注安装方式</a></div>
<div class="p-price"><em>¥</em>23.80</div>
					</li>
				<li>
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1490218770962.jpg" alt=""></a></div>
<div class="p-name"><a href="#">哑铃男士钢制家用电镀哑铃杠铃25 40公斤 纯钢哑铃盒装 健身器材 纯钢哑铃杠铃送哑铃架</a></div>
<div class="p-price"><em>¥</em>360.00</div>
					</li>
				<li>
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1490218732576.jpg" alt=""></a></div>
<div class="p-name"><a href="#">T1多功能健身器材家用仰卧板收腹机哑铃凳仰卧起坐板折叠 健身椅 进口格子皮八档调节 承重500斤</a></div>
<div class="p-price"><em>¥</em>260.00</div>
					</li>
				<li>
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1490218701469.jpg" alt=""></a></div>
<div class="p-name"><a href="#">迪卡侬健身手套 力量训练哑铃护掌防滑 DOMYOS QS 轻盈透气 重量训练</a></div>
<div class="p-price"><em>¥</em>39.90</div>
					</li>
				<li>
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1490218905472.jpg" alt=""></a></div>
<div class="p-name"><a href="#">专业瑜伽服双线美背瑜伽背心吊带含胸垫一体式弹力修身运动健身服</a></div>
<div class="p-price"><em>¥</em>159.00</div>
					</li>
				<li>
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1490218835060.jpg" alt=""></a></div>
<div class="p-name"><a href="#">马克华菲长袖T恤男 冬季新品纯棉圆领黑白潮款印花休闲t恤</a></div>
<div class="p-price"><em>¥</em>98.00</div>
					</li>
			</ul>
		...
		<div class="clear"></div>
				<ul class="brands">
			<li><a href="#"><img src="./img/1490072850306019115.jpg" alt="同庆和堂"></a></li>
<li><a href="#"><img src="./img/1490072931218635674.jpg" alt="皮克朋"></a></li>
<li><a href="#"><img src="./img/1490072898345358625.jpg" alt="皮尔瑜伽"></a></li>
<li><a href="#"><img src="./img/1490073009638652059.jpg" alt="苹果"></a></li>
<li><a href="#"><img src="./img/1490073324022460149.jpg" alt="七匹狼"></a></li>
<li><a href="#"><img src="./img/1490072918339853569.jpg" alt="乔山"></a></li>
<li><a href="#"><img src="./img/1490072889090025069.jpg" alt="斯伯丁"></a></li>
<li><a href="#"><img src="./img/1490072993409028193.jpg" alt="三星"></a></li>
		</ul>
			</div>
</div>
...
<div class="p-btn"><a href="#">加入购物车</a></div>
        ...
        <li style="float: left; width: 158px;">
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1490174508974.jpg" alt=""></a></div>
<div class="p-price">
        <em>¥</em>44.50    </div>
...
<div class="p-btn"><a href="#">加入购物车</a></div>
        ...
        <li style="float: left; width: 158px;">
<div class="p-img"><a href="#"><img src="./img/0_thumb_G_1489100550574.jpg" alt=""></a></div>
<div class="p-price">
        <em>¥</em>258.00    </div>
...
<div class="quick_links_wrap" style="width: 40px;"><div class="quick_link_mian" data-userid="62">
...
<p class="avatar_imgbox">
        <img src="./img/touxiang.jpg" width="100" height="100">
    </p>
<ul class="user_info">
...
<a href="#">意见反馈</a>
    ...
    <script type="text/javascript" src="{{URL::asset('/static/index/js/jquery.SuperSlide.2.1.1.js')}}"></script>
    <script type="text/javascript" src="{{URL::asset('/static/index/js/jquery.yomi.js')}}"></script>
    <script type="text/javascript" src="{{URL::asset('/static/index/js/cart_common.js')}}"></script>
    <script type="text/javascript" src="{{URL::asset('/static/index/js/cart_quick_links.js')}}"></script>
    <script type="text/javascript" src="{{URL::asset('/static/index/js/dsc-common.js')}}"></script>
    <script type="text/javascript" src="{{URL::asset('/static/index/js/asyLoadfloor.js')}}"></script>
    <script type="text/javascript" src="{{URL::asset('/static/index/js/jquery.purebox.js')}}"></script>
    <script type="text/javascript" src="{{URL::asset('/static/index/js/parabola.js')}}"></script>
    <script type="text/javascript" src="{{URL::asset('/static/index/js/suggest.js')}}"></script>


    <script type="text/javascript" src="{{URL::asset('/static/index/js/suggest.js')}}"></script>
{{--
    <script type="text/javascript" src="{{URL::asset('/static/index/js/scroll_city.js')}}"></script>
--}}
    <script type="text/javascript" src="{{URL::asset('/static/index/js/utils.js')}}"></script>
    <script type="text/javascript" src="{{URL::asset('/static/index/js/warehouse.js')}}"></script>
    <script type="text/javascript" src="{{URL::asset('/static/index/js/warehouse_area.js')}}"></script>
