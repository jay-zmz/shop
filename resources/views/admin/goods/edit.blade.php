                                                    ...
                                                    <div id="baseinfo" class="tab-pane active">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="radio">
                                                                    <label>
                                                                        <input  name="on_sale" type="radio" class="colored-blue" value="1" @if($goods['on_sale'] == 1) checked="checked" @endif >
                                                                        <span class="text"> 是</span>
                                                                    </label>
                                                                    <label>
                                                                        <input name="on_sale" type="radio" class="colored-blue" value="0" @if($goods['on_sale'] == 0) checked="checked" @endif>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <select name="cate_id">
                                                                    ...
                                                                    <option value="{{$cate['id']}}" @if($goods['cate_id'] == $cate['id']) selected="selected" @endif >@php echo str_repeat('-', $cate['level']*8) @endphp {{$cate['cate_name']}}  </option>
                                                                        @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <select name="brand_id">
                                                                    ...
                                                                    <option value="{{$brand['id']}}"  @if($goods['brand_id'] == $brand['id']) selected="selected" @endif>{{$brand['brand_name']}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <input class="form-control" placeholder="" name="market_price" required=""  value="{{$goods['market_price']}}" type="text">
                                                            </div>
                                                            <p class="help-block col-sm-4 red">* 必填</p>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                ...
                                                                <select name="weight_unit">
                                                                    <option value="kg" @if($goods['weight_unit'] == "kg") selected="selected" @endif >kg</option>
                                                                    <option value="g" @if($goods['weight_unit'] == "g") selected="selected" @endif>g</option>
                                                                </select>
                                                            </div>
                                                            <p class="help-block col-sm-4 red">* 必填</p>
                                                        </div>
                                                    ...
                                                    <div id="goodsattr" class="tab-pane">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <select name="type_id" >
                                                                    ...
                                                                    @foreach($typeRes as $type)
                                                                        <option value="{{$type['id']}}" @if($goods['type_id'] == $type['id']) selected="selected" @endif readyonly>{{$type['type_name']}}</option>
                                                                       @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div id="attr_list">
                                                            @foreach($attrRes as $k=>$v)
                                                                @if($v['attr_type'] == 1)
                                                                    @php $arrRido = explode(',',$v['attr_value']); @endphp
                                                                    
                                                                    @foreach($gattrRes[$v['id']]  as $k1=>$v1)
                                                                    <div class="form-group" gaid={{$v1['id']}}>
                                                                        <label for="username" class="col-sm-2 control-label no-padding-right">{{$v['attr_name']}}</label>
                                                                        <div class="col-sm-6">
                                                                            <a class="abtn" onclick="addrow(this);" href="#">@if ($k1 == 0 ) [+] @else [-] @endif </a>
                                                                            <select name='old_goods_attr[{{$v['id']}}][]'>
                                                                                @foreach($arrRido as $k2=>$v2)
                                                                                <option @if($v1['attr_value'] == $v2) selected="selected" @endif >{{$v2}}</option>
                                                                                @endforeach
                                                                            </select>
                                                                            <input class="form-control price" placeholder="价格" name="old_attr_price[{{$v1['id']}}]" type="text" value="{{$v1['attr_price']}}">
